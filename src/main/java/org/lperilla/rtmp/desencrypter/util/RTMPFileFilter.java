 ...
 *
 */
public class RTMPFileFilter extends javax.swing.filechooser.FileFilter implements java.io.FileFilter {
     ...
     */
    public RTMPFileFilter(String[] extensions) {
     ...
     */
    public RTMPFileFilter(String[] extensions, boolean allow) {
        exts = extensions;
        allowDirs = allow;
    }
